...
declare namespace fp {
  ...
  interface Static {
     ...
     */
    set<T extends Object>(path: string, value: any, object: T): T;
     ...
     */
    mapKeys<T1, T2 extends Dictionary<any>>(iteratee: (k: keyof T1) => (keyof T2), object: T1): T2;
    mapKeys<T1, T2 extends Dictionary<any>>(iteratee: (k: keyof T1) => (keyof T2)): (object: T1) => T2;
